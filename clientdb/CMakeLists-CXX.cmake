...
ELSEIF(${SERVER} STREQUAL "MYSQL")
	...
	ADD_LIBRARY(octetos-toolkit-cliendb-myc++ STATIC clientdb.cpp clientdb-mysql.cpp)
	TARGET_LINK_LIBRARIES(octetos-toolkit-cliendb-myc++ ${OCTETOS_TOOLKIT_COMMON_CPP_LIBRARY} ${MYSQL_LIBRARY} ${DWARF_LIBRARY})
	INSTALL(TARGETS octetos-toolkit-cliendb-myc++ DESTINATION lib/toolkit/clientdb)

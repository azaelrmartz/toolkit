...
ENDIF()
FIND_PACKAGE(dwarf REQUIRED PATHS ${PROJECT_SOURCE_DIR}/../cmake/Modules/)
IF(DWARF_FOUND)
...
ELSEIF(${SERVER} STREQUAL "MYSQL")
        SET(liba-clientdb-mysql-c++ mysql-c++)
	...
	ADD_LIBRARY(${liba-clientdb-mysql-c++} STATIC clientdb.cpp clientdb-mysql.cpp)
	TARGET_LINK_LIBRARIES(${liba-clientdb-mysql-c++} ${TOOLKIT_COMMON_LIBRARY} ${MYSQL_LIBRARY} ${DWARF_LIBRARY})
	INSTALL(TARGETS ${liba-clientdb-mysql-c++} DESTINATION lib/toolkit/clientdb)

PROJECT(octetos-toolkit-clientdb-myc++ VERSION 5.4.0.5 LANGUAGES ${LANG})
...
elseif(${OCTKCLCC_VERSION_STAGE} STREQUAL "release")
...
elseif(${CMAKE_BUILD_TYPE} STREQUAL "Release")
        if(NOT OCTKCLCC_VERSION_STAGE)
                MESSAGE(FATAL_ERROR "Asigno CMAKE_BUILD_TYPE = Release para que los componentes de APIDB funcione correctamente es necesario que asigne OCTKCLCC_VERSION_STAGE = release")
	elseif(NOT ${OCTKCLCC_VERSION_STAGE} STREQUAL "release")
		MESSAGE(FATAL_ERROR "Asigno CMAKE_BUILD_TYPE = Release para que los componentes de APIDB funcione correctamente es necesario que asigne OCTKCLCC_VERSION_STAGE = release")
        endif()
endif()

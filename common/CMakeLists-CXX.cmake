PROJECT(octetos-toolkit-common-c++ VERSION 4.0.0.1 LANGUAGES ${LANG})
...
ADD_EXECUTABLE(testing-v${octetos-toolkit-common-c++_VERSION_MAJOR} tests/v${octetos-toolkit-common-c++_VERSION_MAJOR}.cc common.cpp parserVersion-C++/driver.cc ${FLEX_lexer_OUTPUTS} ${BISON_parser_OUTPUTS})
TARGET_LINK_LIBRARIES(testing-v${octetos-toolkit-common-c++_VERSION_MAJOR} ${CUNIT_LIBRARY})

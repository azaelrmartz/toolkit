...
ADD_LIBRARY(common-c++-a-1step STATIC  common.cpp parserVersion-C++/driver.cc ${FLEX_lexer_OUTPUTS} ${BISON_parser_OUTPUTS})
ADD_LIBRARY(common-c++-a.${toolkit-common_VERSION_MAJOR} STATIC common-parser.cpp  ${FLEX_lexer_OUTPUTS} ${BISON_parser_OUTPUTS})
TARGET_LINK_LIBRARIES(common-c++-a.${toolkit-common_VERSION_MAJOR} common-c++-a-1step)
...
INSTALL(TARGETS common-c++-a.${toolkit-common_VERSION_MAJOR} DESTINATION lib/toolkit/common/)
